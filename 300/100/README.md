...
Initiative: **Master Application Creation**
...
Hence, mastering application creation has been successful if we either ```practise how to do it properly``` or we ```succeed in producing it completely```. 
